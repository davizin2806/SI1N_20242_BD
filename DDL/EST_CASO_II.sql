...
AEROPORTO_LONGITUDE DECIMAL(30),
AEROPORTO_LATITUDE DECIMAL(30)
);
...
constraint FK_FUNCIONARIOS foreign key (FUNC_EQUIPE)
REFERENCES FUNCIONARIOS(FUNC_ID),
CONSTRAINT FK_VOOS FOREIGN KEY (VOO_EQUIPE)

...
CONSTRAINT FK_TELEFONE FOREIGN KEY(TELEFONE_CLIENTE) 
REFERENCES TELEFONES(NUM_TELEFONE),
CONSTRAINT FK_ENDEREÇO FOREIGN KEY(END_CLIENTE)
REFERENCES ENDEREÇO(ID_END),
CONSTRAINT FK_TIPO_TEL FOREIGN KEY(TIPO_TELEFONE)
REFERENCES TIPO_TEL(ID_TEL),
CONSTRAINT FK_ENCOMENDAS FOREIGN KEY(CLIENTE_ENC)
...
CONSTRAINT FK_TELEFONE FOREIGN KEY(TELEFONE_EMPREGADO) 
REFERENCES TELEFONES(NUM_TELEFONE),
CONSTRAINT FK_ENDERECO FOREIGN KEY(END_EMPREGADO)
REFERENCES ENDERECO(ID_END),
CONSTRAINT FK_PRODUTOS FOREIGN KEY(EMPREGADO_PROD)
...
CONSTRAINT FK_TELEFONE FOREIGN KEY(TELEFONE_EMPRESA) 
REFERENCES TELEFONES(NUM_TELEFONE),
CONSTRAINT FK_ENDERECO FOREIGN KEY(ENDERECO_EMPRESA)
REFERENCES ENDERECO(ID_END)
);
...
CONSTRAINT FK_PRODUTOS FOREIGN KEY(ENC_PRODUTOS)
REFERENCES PRODUTOS(ID_PROD),
);
...
REFERENCES ENCOMENDAS(ID_ENC),
CONSTRAINT FK_COMPONENTES FOREIGN KEY(COMP_ENCOMENDAS)
REFERENCES COMPONENTES(ID_COMP),
CONSTRAINT FK_RE FOREIGN KEY(RE_PROD)
REFERENCES RE(ID_RE),
CONSTRAINT FK_RS FOREIGN KEY(RS_PROD)
REFERENCES RS(ID_RS)
);
...
PREÇO_COMP INT NOT NULL,
CONSTRAINT FK_FORNECEDORES FOREIGN KEY(COMP_FORNECEDOR)
REFERENCES FORNECEDORES(CNPJ_FORN),
CONSTRAINT FK_TIPO_COMPONENTE FOREIGN KEY(TIPO_COMP)
REFERENCES TIPO_COMPONENTE(ID_TC)
);
...
ALTER TABLE TIPO_COMPONENTE MODIFY NOME_TC VARCHAR(60);
...
ALTER TABLE TELEFONE ADD DDD_TELEFONE INT;

CREATE TABLE IF NOT EXISTS TIPO_END(
ID_TIPO INT PRIMARY KEY
);

ALTER TABLE TELEFONE ADD NOME_TIPO VARCHAR(30);
